...
class NsmRevvedUrlPlugin extends BasePlugin
{
    /**
    ...
    {
        return 'https://github.com/newism/nsm/craftcms-revved-url/blob/master/README.md';
    }
    ...
    {
        return 'https://github.com/newism/nsm/craftcms-revved-url/master/releases.json';
    }
    ...
    {
        Craft::import('plugins.nsmrevvedurl.twigextensions.NsmRevvedUrlTwigExtension');

        return new NsmRevvedUrlTwigExtension();
    }
